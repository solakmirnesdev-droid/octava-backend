...
describe('otisak', () => {
  test('isti zvuk daje isti otisak', () => {
...
describe('prepoznavanje', () => {
  ...
  test('duzi isjecak nosi vecu rezervu', () => {
  ...
  test('stopa ne raste s duzinom snimka', () => {
...
describe('odbijanje', () => {
  ...
  test('prag je stopa, ne broj pogodaka', () => {
  ...
  test('tijesna prednost nije pogodba', () => {
    assert.equal(best([{ id: 'a', score: 300 }, { id: 'b', score: 250 }], 1000), null);
  });

  test('stopa ispod praga pada bez obzira na prednost', () => {
