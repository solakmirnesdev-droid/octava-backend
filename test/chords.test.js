...
describe('notacija', () => {
  ...
  test('nikad ne ispisuje snizilice', () => {
    for (let n = -11; n <= 11; n++) {
  ...
  test('cita oba sistema na ulazu', () => {
  ...
  test('normalizacija prepisuje zateceni zapis', () => {
...
describe('transpozicija', () => {
  test('vraca se na pocetak nakon oktave', () => {
    const song = '[Am]a [F]b [C]c [G/H]d';
    assert.equal(transposeContent(song, 12, 'Am'), song);
  });

  test('+7 i -5 daju isto', () => {
...
describe('oznake dijelova', () => {
  ...
  test('prezive transpoziciju neizmijenjene', () => {
...
describe('rubni slucajevi', () => {
  ...
  test('nepoznat tonalitet vraca ulaz', () => {
